/*************************************************************************
 *  Compilation:  javac DijkstraPriceSP.java
 *  Execution:    java DijkstraPriceSP V E
 *  Dependencies: WeightedGraph.java IndexMinPQ.java Stack.java Edge.java
 *
 *  Dijkstra's algorithm. Computes the shortest path tree based on edge price.
 *  Assumes all weights are nonnegative.
 *
 *************************************************************************/
import java.util.*;
public class DijkstraPriceSP {
    ...
    */
    public DijkstraPriceSP(WeightedGraph G, int s) {
    ...
    */
    ...
    /**
    * shortest path from s to v as an Iterable based on price, null if no such path
    *
