...
// Modified for CS 1501 Summer 2020
...
// To execute this handout you must also have the classes above available.  Use
// the command:
// $ java FordFulkerson flowtest1.txt BFS
// $ java FordFulkerson flowtest2.txt BFS
// $ java FordFulkerson flowtest3.txt BFS
//
// $ java FordFulkerson flowtest1.txt PFS
// $ java FordFulkerson flowtest2.txt PFS
// $ java FordFulkerson flowtest3.txt PFS
//
// flowtest1.txt is the first example traced in Lecture 19
// flowtest2.txt is the example with backward flow (in both Lect. 19 and Lect. 20)
// flowtest3.txt is an additional example 
...
public class FordFulkerson {
    ...
    // return an augmenting path if one exists, otherwise return null.  This
    // augmenting path will have the fewest total edges.  If more than one
    // augmenting path have the same fewest number of edges, this will choose
