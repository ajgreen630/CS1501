...
public class ExtraChatServer {
    ...
    public ExtraChatServer(int MaxU) throws IOException
    {
        MaxUsers = MaxU;
    ...
    public synchronized void SendMsg(String msg)
            ...
            // it to encode the message, and sen the result.
		...
		while (true)
		{
			if (numUsers < MaxUsers)
			{
				try
				{
                    ...
                    String password = "CS1501RULEZ";    // Server-side password.  You can update this so all clients
                                                        // must enter the password decided by the server.
                    byte [] passwordBytes = cipher.encode(password);
                    tempWriter.writeObject(passwordBytes); tempWriter.flush();
              ...
              while (ok)
              {
                    ...
                    try {
						 ...
						 if (newBytes == null || newMsg.equals("CLIENT CLOSING"))
                             	...
                             	ExtraChatServer.this.SendMsg(newMsg);
                    }
                    catch (Exception e)
                    {
    ...
    {
         ExtraChatServer Secure = new ExtraChatServer(30);
    }
}